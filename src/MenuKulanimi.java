 ...
 * @author eneso
 */
public class MenuKulanimi extends javax.swing.JFrame {

    /**
     * Creates new form MenuKulanimi
     */
    public MenuKulanimi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Renk Deðiþtir");
        ...
        jMenu2.setText("Yazý Tipi");

        jMenuItem5.setText("Arail");
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        Color color = JColorChooser.showDialog(this, "Yazý Rengi", Color.black);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuKulanimi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuKulanimi().setVisible(true);
            }
        });
    }
